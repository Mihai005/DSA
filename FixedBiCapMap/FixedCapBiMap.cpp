...
//WC: Theta(mapSize) - when the key c appears only once or zero tiems in the map
//TC: O(mapSize)
...
//WC: Theta(mapSize) - when the pair we want to remove is on the last position or it is not in the map
//TC: O(mapSize)
